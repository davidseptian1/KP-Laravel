...
Route::middleware(['checkLogin', 'admin.activity.log'])->group(function () {
    ...
    Route::get('deposit/request/{id}/bukti-bayar-hutang-image', [DepositFormController::class, 'viewBuktiBayarHutangImage'])->name('deposit.request.bukti-bayar-hutang-image');
    ...
    Route::middleware('isAdmin')->group(function () {
        ...
        Route::get('admin/deposit/monitoring-hutang', [AdminDepositController::class, 'monitoringHutang'])->name('admin.deposit.monitoring-hutang');
    ...
    Route::middleware('isAdminSosmed')->group(function () {
        ...
        Route::post('admin/sosmed/submissions/{id}/restore', [AdminSosmedController::class, 'restoreSubmission'])->name('admin.sosmed.submissions.restore');
