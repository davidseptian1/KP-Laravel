...
<div class="card border-0 bg-warning-subtle mb-3">
    <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 py-2">
        <div>
            <div class="fw-semibold text-warning-emphasis mb-1"><i class="ti ti-report-money me-1"></i>Total Deposit (Sesuai Filter)</div>
            <small class="text-muted d-block">Jumlah request deposit sesuai filter: {{ number_format($totalRequest, 0, ',', '.') }}</small>
        </div>
