        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Riwayat Tagihan PLN & Internet</li>
                </ul>
            </div>
            <div class="col-md-12">
                <div class="page-header-title">
                    <h2 class="mb-0">Riwayat Tagihan PLN & Internet</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @forelse ($items as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->parent->nomor_pln_internet ?? '-' }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-4">Belum ada riwayat tagihan PLN & Internet</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
